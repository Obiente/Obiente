...
export const GET: APIRoute = async ({ redirect }) => {
  try {
    const response = await fetch('https://discord.com/api/guilds/1168343363318202428/widget.json');
    ...
    return new Response('Discord couldn\'t fetch an invite, please try again later.', {
      status: 503,
      headers: {
